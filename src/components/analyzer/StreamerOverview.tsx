...
export const StreamerOverview = ({ result }: { result: AnalysisResult }) => (
  <Card className="bg-card border-border">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <CardTitle className="truncate text-lg text-foreground">{result.displayName}</CardTitle>
            {result.description && (
    ...
    <CardContent className="grid grid-cols-2 gap-2.5 sm:gap-4 md:grid-cols-5">
      {[
