...
const InboxPage = () => {
  const [contacts, setContacts] = useState<Contact[]>([
    {
      id: "1",
      name: "StreamerExample",
      platform: "twitch",
      channelUrl: "https://twitch.tv/streamerexample",
      lastMessage: "Hey, I'd love to chat about growing your channel!",
      status: "active",
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="bg-card border-border">
              ...
              <div className="space-y-4 mt-2">
                ...
                <Button onClick={handleAddContact} className="w-full gradient-primary text-primary-foreground">
                  Add Contact
                </Button>
              </div>
            </DialogContent>
          ...
          {filteredContacts.length === 0 ? (
            <Card className="bg-card border-border">
              <CardContent className="p-8 text-center text-muted-foreground">
                ...
                <p>No contacts yet. Add your first streamer contact!</p>
              </CardContent>
            </Card>
          ) : (
